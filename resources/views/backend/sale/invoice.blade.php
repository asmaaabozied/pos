        ...
        <table>
            <tbody>
                ...
                <tr style="background-color:#ddd;">
                    ...
                    <td style="padding: 5px;width:40%">{{trans('file.Amount')}}: {{\App\Models\Currency::where('name','=',$payment_data->currency)->first()->code ?? ''}} {{number_format((float)$payment_data->cash_received, $general_setting->decimal, '.', ',')}} </td>
                    <td style="padding: 5px;width:30%">$ {{number_format((float)($payment_data->amount), $general_setting->decimal, '.', ',')}} </td>
                </tr>
                @endforeach
