                ...
                <table class="table table-hover payment-list">
                    <thead>
                        <tr>
                            ...
                            <th>{{trans('file.Cash Received')}}</th>
...
<script type="text/javascript">
    ...
    $(document).on("click", "table.sale-list tbody .get-payment", function(event) {
        ...
        $.get('sales/getpayment/' + id, function(data) {
            ...
            paid_amount = data[2];
            cash_received = data[3];
            currency = data[4];
            paying_method = data[5];
            payment_id = data[6];
            payment_note = data[7];
            cheque_no = data[8];
            gift_card_id = data[9];
            change = data[10];
            paying_amount = data[11];
           

            
            account_name = data[12];
            account_id = data[13];
            payment_receiver = data[14];
            ...
            $.each(payment_date, function(index) {
                ...
                cols += '<td>' + cash_received[index] + '</td>';
                cols += '<td>' + currency[index] + '</td>';
