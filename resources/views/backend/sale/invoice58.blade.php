...
{{--                    @endif--}}
                    ...
                    <tr style="background-color:#ddd;">
                        ...
                        <td style="text-align:center;padding: 5px;width:30%">{{trans('file.Amount')}}:<br> {{\App\Models\Currency::where('name','=',$payment_data->currency)->first()->code ?? ''}}{{number_format((float)$payment_data->cash_received, $general_setting->decimal, '.', ',')}} </td>
                        <td style="text-align:center;padding: 5px;width:30%">$ {{number_format((float)($payment_data->amount), $general_setting->decimal, '.', ',')}}<br> </td>
                    </tr>
                    @endforeach
