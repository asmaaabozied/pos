...
@push('css')
    <style type="text/css">
        ...
        @media all and (max-width: 767px) {
            ...
            .more-payment-options, .more-payment-options .btn-group {
                width: 100%
            }
                    ...
                    <header>
                        <nav class="navbar">
                            ...
                            <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                                <li class="nav-item ml-4 d-md-none"><a data-toggle="collapse" href="#collapseProducts"
                                                                       role="button" aria-expanded="false"
                                                                       aria-controls="collapseProducts"><i
                                            class="fa fa-cubes"></i></a></li>
                                <li class="nav-item ml-4 d-none d-lg-block"><a id="btnFullscreen" data-toggle="tooltip"
                                                                               title="Full Screen"><i
                ...
                ['role_id', \Auth::user()->role_id] ])->first();
                    ...
                    <div class="row">
                                        ...
                                        <div class="input-group pos">
                                            <select required name="customer_id" id="customer_id"
                                                ...
                                                $points[$customer->id] = $customer->points;
                                                    @endphp
                                                    <option
                                                        value="{{$customer->id}}">{{$customer->name}} @if($customer->phone_number)
                                                            ({{$customer->phone_number}})@endif</option>
                                                @endforeach
                                            </select>
                                            @if($customer_active)
                                                <button type="button" class="btn btn-default btn-sm" data-toggle="modal"
                                                        data-target="#addCustomer"><i class="dripicons-plus"></i>
                                                </button>
                                            @endif
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-1 col-12">
                            <a class="btn btn-primary btn-block more-options" data-toggle="collapse" href="#moreOptions"
                               role="button" aria-expanded="false" aria-controls="moreOptions"><i
                                    class="dripicons-dots-3"></i></a>
                        </div>
                    </div>
                    <div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    @elseif($field->type == 'checkbox')
                                                        ...
                                                        @foreach($option_values as $value)
                                                            <label>
                                                                <input type="checkbox"
                                                                       name="{{str_replace(' ', '_', strtolower($field->name))}}[]"
                                                                       value="{{$value}}" @if($value==$field->default_value){{'checked'}}@endif @if($field->is_required){{'required'}}@endif> {{$value}}
                                                            </label>
                                                            &nbsp;
                                                        @endforeach
                                                    ...
                                                    @elseif($field->type == 'select')
                                                        ...
                                                        <select class="form-control"
                                                                name="{{str_replace(' ', '_', strtolower($field->name))}}" @if($field->is_required){{'required'}}@endif>
                                                            @foreach($option_values as $value)
                                                                <option
                                                                    value="{{$value}}" @if($value==$field->default_value){{'selected'}}@endif>{{$value}}</option>
                                                            @endforeach
                                                        </select>
                        ...
                        <div class="col-12 pl-0 pr-0">
                            <div class="search-box form-group mb-2">
                                <input style="border: 1px solid #7c5cc4;" type="text" name="product_code_name"
                                       id="lims_productcodeSearch" placeholder="Scan/Search product by name/code"
                                       class="form-control"/>
                            </div>
                        </div>
                                    ...
                                    @foreach($lims_product_sale_data as $product_sale)
                                        <tr>
                                            ...
                                            <td class="col-sm-5 col-6 product-title">
                                                <strong class="edit-product btn btn-link" data-toggle="modal"
                                                        data-target="#editModal">{{$product_data->name}} <i
                                                        class="fa fa-edit"></i></strong><br><span>{{$product_data->code}}</span>
                                                | In Stock: <span class="in-stock">{{$product_data->in_stock}}</span>
                                                <strong
                                                    class="product-price d-md-none">{{ number_format((float)($product_sale->total / $product_sale->qty), $general_setting->decimal, '.', '')}}</strong>

                                                @if($product_batch_data)
                                                    <br><input
                                                        style="font-size:13px;padding:3px 25px 3px 10px;height:30px !important"
                                                        type="text" class="form-control batch-no"
                                                        value="{{$product_batch_data->batch_no}}" required/> <input
                                                        type="hidden" class="product-batch-id" name="product_batch_id[]"
                                                        value="{{$product_sale->product_batch_id}}"/>
                                                @else
                                                    <input type="text" class="form-control batch-no d-none" disabled/>
                                            ...
                                            <td class="col-sm-3">
                                                <div class="input-group"><span class="input-group-btn"><button
                                                            type="button" class="ibtnDel btn btn-danger btn-sm mr-3"><i
                                                                class="dripicons-cross"></i></button><button
                                                        ...
                                                        class="input-group-btn"><button type="button"
                                                                ...
                                                                class="dripicons-plus"></span></button></span></div>
                                            </td>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <input type="hidden" name="total_discount"
                                           value="@if(isset($lims_sale_data)) {{$lims_sale_data->total_discount}} @else {{number_format(0, $general_setting->decimal, '.', '')}} @endif"/>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <input type="hidden" name="total_tax"
                                           value="@if(isset($lims_sale_data)) {{$lims_sale_data->total_tax}} @else {{number_format(0, $general_setting->decimal, '.', '')}} @endif"/>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="order_tax"
                                           value="@if(isset($lims_sale_data)) {{$lims_sale_data->order_tax}} @else {{number_format(0, $general_setting->decimal, '.', '')}} @endif"/>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <input type="hidden" name="grand_total"
                                           value="@if(isset($lims_sale_data)) {{number_format((float)$lims_sale_data->grand_total, $general_setting->decimal, '.', '')}} @else {{number_format(0, $general_setting->decimal, '.', '')}} @endif"/>
                                    ...
                                    <input type="hidden" name="coupon_discount"
                                           value="{{$lims_sale_data->coupon_discount ?? 0}}"/>
                        ...
                        <div class="col-12 totals"
                            ...
                            <div class="row">
                                <div class="col-sm-4 col-6">
                                    <strong class="totals-title">{{trans('file.Items')}}</strong><strong
                                        id="item">{{$lims_sale_data->item ?? 0}} ({{$lims_sale_data->total_qty ?? 0}}
                                        )</strong>
                                </div>
                                <div class="col-sm-4 col-6">
                                    <strong class="totals-title">{{trans('file.Total')}}</strong><strong
                                        id="subtotal">@if(isset($lims_sale_data)) {{number_format((float)$lims_sale_data->total_price, $general_setting->decimal, '.', '')}} @else {{number_format(0, $general_setting->decimal, '.', '')}} @endif</strong>
                                </div>
                                <div class="col-sm-4 col-6">
                                    <strong class="totals-title">{{trans('file.Discount')}}
                                        <button type="button" class="btn btn-link btn-sm" data-toggle="modal"
                                                data-target="#order-discount-modal"><i
                                                class="dripicons-document-edit"></i></button>
                                    </strong><strong
                                        id="discount">@if(isset($lims_sale_data)) {{number_format((float)$lims_sale_data->order_discount, $general_setting->decimal, '.', '')}} @else {{number_format(0, $general_setting->decimal, '.', '')}} @endif</strong>
                                </div>
                                <div class="col-sm-4 col-6">
                                    <strong class="totals-title">{{trans('file.Coupon')}}
                                        <button type="button" class="btn btn-link btn-sm" data-toggle="modal"
                                                data-target="#coupon-modal"><i class="dripicons-document-edit"></i>
                                        </button>
                                    </strong><strong
                                        id="coupon-text">@if(isset($lims_sale_data)) {{number_format((float)$lims_sale_data->coupon_discount, $general_setting->decimal, '.', '')}} @else {{number_format(0, $general_setting->decimal, '.', '')}} @endif</strong>
                                </div>
                                <div class="col-sm-4 col-6">
                                    <strong class="totals-title">{{trans('file.Tax')}}
                                        <button type="button" class="btn btn-link btn-sm" data-toggle="modal"
                                                data-target="#order-tax"><i class="dripicons-document-edit"></i>
                                        </button>
                                    </strong><strong
                                        id="tax">@if(isset($lims_sale_data)) {{number_format((float)$lims_sale_data->order_tax, $general_setting->decimal, '.', '')}} @else {{number_format(0, $general_setting->decimal, '.', '')}} @endif</strong>
                                </div>
                                <div class="col-sm-4 col-6">
                                    <strong class="totals-title">{{trans('file.Shipping')}}
                                        <button type="button" class="btn btn-link btn-sm" data-toggle="modal"
                                                data-target="#shipping-cost-modal"><i
                                                class="dripicons-document-edit"></i></button>
                                    </strong><strong
                                        id="shipping-cost">@if(isset($lims_sale_data)) {{number_format((float)$lims_sale_data->shipping_cost, $general_setting->decimal, '.', '')}} @else {{number_format(0, $general_setting->decimal, '.', '')}} @endif</strong>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="payment-amount d-none d-md-block">
                        <h2>{{trans('file.grand total')}} <span
                                id="grand-total">@if(isset($lims_sale_data)) {{number_format((float)$lims_sale_data->grand_total, $general_setting->decimal, '.', '')}} @else {{number_format(0, $general_setting->decimal, '.', '')}} @endif</span>
                        </h2>
                    </div>
                                ...
                                <div class="">
                                    @if(in_array("card",$options))
                                        <div class="column-5">
                                            <button style="background: #0984e3" type="button"
                                                    ...
                                                    data-target="#add-payment" id="credit-card-btn"><i
                                    ...
                                    @if(in_array("cash",$options))
                                        <div class="column-5">
                                            <button style="background: #00cec9" type="button"
                                                    class="btn btn-sm btn-custom payment-btn" data-toggle="modal"
                                                    data-target="#add-payment" id="cash-btn"><i
                                    ...
                                    <div class="column-5">
                                        <button style="background: #010429" type="button"
                                                class="btn btn-sm btn-custom payment-btn" data-toggle="modal"
                                                data-target="#add-payment" id="multiple-payment-btn"><i
                                                class="fa fa-money"></i> {{trans('file.Multiple Payment')}}</button>
                                    </div>
                                    ...
                                    @if(in_array("gift_card",$options))
                                        <div class="column-5">
                                            <button style="background-color: #5f27cd" type="button"
                                                    ...
                                                    class="fa fa-credit-card-alt"></i> {{trans('file.Gift Card')}}
                                            </button>
                                        </div>
                                    @endif
                                    ...
                                    @if($lims_reward_point_setting_data && $lims_reward_point_setting_data->is_active)
                                        <div class="column-5">
                                            <button style="background-color: #319398" type="button"
                                                    class="btn btn-sm btn-block btn-custom payment-btn"
                                                    data-toggle="modal" data-target="#add-payment" id="point-btn"><i
                                        ...
                                        <div class="col-md-10" id="payment-select-row">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 col-6 mt-1">
                                                    ...
                                                    <select name="currency[]"
                                                            class="form-control selectpicker currencss" id="currencss">
                                                        @foreach($currency_list as $key)
                                            ...
                                            <div class="row add-more-row mt-2">
                                                <div class="col-md-12 text-center">
                                                    <button class="btn btn-info add-more">
                                                        + {{trans('file.Add More Payment')}}</button>
                                                </div>
                                            </div>
                                            <div class="row">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <h5 id="exampleModalLabel"
                                        class="modal-title">{{trans('file.Add Cash Register')}}</h5>
                                    <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span
                                            aria-hidden="true"><i class="dripicons-cross"></i></span></button>
                                </div>
                                <div class="modal-body">
                                            ...
                                            <table class="table table-hover">
                                                ...
                                                @if(in_array("card",$options))
                                                    <tr>
                                                        ...
                                                        <td id="credit_card_payment" class="text-right">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <table class="table table-hover">
                                            ...
                                            <tr>
                                                <td>{{trans('file.Credit Card Payment')}}:</td>
                                                <td class="credit_card_payment text-right">
                                                </td>
    ...
    <script type="text/javascript">
            ...
            var htmlText = `<div class="row new-row">
                         ...
                         <input type="text" name="paying_amount[]" class="form-control paying_amount numkey" required step="any">
                               ...
                               <div class="col-md-3 col-6 mt-2">
                                                <label>{{trans('file.Currency')}} *</label>
                                                <select name="currency[]" class="form-control selectpicker currencss" id="currencss">
                                                    @foreach($currency_list as $key)
            <option value="{{$key->name}}">{{$key->name}}</option>
                                                  @endforeach
            </select>
        ...
        $("#register-details-btn").on("click", function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#register-details-modal #credit_card_payment #currency ').text(data['credit_card_payment']['currency']);
        ...
        $("#today-sale-btn").on("click", function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    var array = data['credit_card_payment_currency'];
                    var skillhtml = '';
                    if (data['credit_card_payment'] !== 0) {
                        $.each(array, function (key, value) {

                            skillhtml = skillhtml + '<tr><td style="border:1px solid black"> ' + value.currency + '</td><td style="border:1px solid black"> ' + value.cash_received + '</td><tr>';
                        });

                        $("#today-sale-modal .credit_card_payment").html(data['credit_card_payment'] + '<table style="width:100%"><tr><th style="border:1px solid black">Currency</th><th style="border:1px solid black">Cash Received</th></tr>' + skillhtml + '</table><hr>');

                    }
                    if (data['gift_card_payment'] !== 0) {
                        // console.log("data['gift_card_payment']",data['gift_card_payment']);
                        var gift = '';
                        $.each(data['gift_card_payment_currency'], function (key, value) {

                            gift = gift + '<tr><td style="border:1px solid black"> ' + value.currency + '</td><td style="border:1px solid black"> ' + value.cash_received + '</td><tr>';
                        });
                        $("#today-sale-modal .gift_card_payment").html(data['gift_card_payment'] + '<table style="width:100%"><tr><th style="border:1px solid black">Currency</th><th style="border:1px solid black">Cash Received</th></tr>' + gift + '</table><hr>');
                    }

                    if (data['deposit_payment'] !== 0) {

                        var deposit = '';
                        $.each(data['deposit_payment_currency'], function (key, value) {
                            deposit = deposit + '<tr><td style="border:1px solid black"> ' + value.currency + '</td><td style="border:1px solid black"> ' + value.cash_received + '</td><tr>';
                        });
                        $("#today-sale-modal .deposit_payment").html(data['deposit_payment'] + '<table style="width:100%"><tr><th style="border:1px solid black">Currency</th><th style="border:1px solid black">Cash Received</th></tr>' + deposit + '</table><hr>');
                    }

                    if (data['cash_payment'] !== 0) {
                        console.log("data['cash_payment_currency']", data['cash_payment_currency']);
                        var cash = '';

                        $.each(data['cash_payment_currency'], function (key, value) {

                            cash = cash + '<tr><td style="border:1px solid black"> ' + value.currency + '</td><td style="border:1px solid black"> ' + value.cash_received + '</td><tr>';
                        });
                        $("#today-sale-modal .cash_payment").html(data['cash_payment'] + '<table style="width:100%"><tr><th style="border:1px solid black">Currency</th><th style="border:1px solid black">Cash Received</th></tr>' + cash + '</table><hr>');
                    }


                    if (data['cheque_payment'] !== 0) {
                        console.log("data['cheque_payment_currency']", data['cheque_payment']);
                        var cheque = '';
                        var pay = data['cheque_payment_currency'];
                        $.each(pay, function (key, value) {

                            cheque = cheque + '<tr><td style="border:1px solid black"> ' + value.currency + '</td><td style="border:1px solid black"> ' + value.cash_received + '</td><tr>';
                        });

                        $("#today-sale-modal .cheque_payment").html(data['cheque_payment'] + '<table style="width:100%"><tr><th style="border:1px solid black">Currency</th><th style="border:1px solid black">Cash Received</th></tr>' + cheque + '</table><hr>');


                    }


                    if (data['paypal_payment'] !== 0) {
                        console.log("data['paypal_payment_currency']", data['paypal_payment_currency']);
                        var paypal = '';
                        var pays = data['paypal_payment_currency'];
                        $.each(pays, function (key, value) {

                            paypal = paypal + '<tr><td style="border:1px solid black"> ' + value.currency + '</td><td style="border:1px solid black"> ' + value.cash_received + '</td><tr>';
                        });

                        $("#today-sale-modal .paypal_payment").html(data['paypal_payment'] + '<table style="width:100%"><tr><th style="border:1px solid black">Currency</th><th style="border:1px solid black">Cash Received</th></tr>' + paypal + '</table><hr>');
        ...
        function appendRemoveElement(className) {
            ...
            if (className == 'cash') {
                ...
                appendElement = `
            <div class="form-group col-md-12 credit-card remove-element"></div>
                                <div class="row">
                                    <div class="col-md-5">
        ...
        $(document).on("change", 'select[name="paid_by_id_select[]"]', function () {
            ...
            //gift
                ...
                $(this).closest('.row').append(appendElement);
        ...
        $(document).on("keyup", '.paying_amount', function () {
            ...
            let currency = $($row).find('select[name="currency[]"].currencss').val();
            let paid_amounts = parseFloat($row.find('.paying_amount').val()) || 0;
            console.log("currency", currency);

            if (currency == 'US Dollar') {
                $($row).find('.paid_amount').val(paid_amounts);
                console.log('amount', paid_amounts);
            } else {

                $.ajax({
                    type: 'GET',
                    async: false,
                    url: '{{url("/")}}/currencies/check-currency?currency=' + currency + '&amount=' + paid_amounts,
                    success: function (data) {
                        console.log(data);
                        $($row).find('.paid_amount').val(data);
        ...
        function updateChange() {
            let change = 0;
            // console.log("paying",$('.total_paying').text());
            // console.log("payable",$('.total_payable').text());
            let total_paying = $('.total_paying').text();
            let total_payable = $('.total_payable').text();
            change = total_payable - total_paying;
        ...
        $(document).on("change", 'select[name="currency[]"].currencss', function () {
            // $('select[name="currency[]"].currencss').change(function(){
            let $row = $(this).closest('.row');
            var currency = $(this).val();
            pay = $($row).find('.paying_amount').val();
            console.log("pay", pay);
            if (currency == 'US Dollar') {
                console.log("currenies", currency);
                $($row).find('.paid_amount').val(pay)
            } else {

                $.ajax({
                    type: 'GET',
                    async: false,
                    url: '{{url("/")}}/currencies/check-currency?currency=' + currency + '&amount=' + pay,
                    success: function (data) {
                        console.log(data);
                        $($row).find('.paid_amount').val(data);
        ...
        $(document).on('submit', '.payment-form', function (e) {
            ...
            if (rownumber < 0) {
                ...
                // else if( parseFloat( $('input[name="paid_amount[]"]').val() ) < parseFloat( $('input[name="paying_amount[]"]').val() ) ){

                alert('Paid amount cannot be bigger than recieved amount');
                e.preventDefault();
            } else {
